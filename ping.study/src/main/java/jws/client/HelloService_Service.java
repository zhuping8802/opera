 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://jws/client", wsdlLocation = "http://localhost:8088/ws/HelloService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://jws/client", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8088/ws/HelloService?wsdl");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://jws/client", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://jws/client", "HelloServicePort"), HelloService.class, features);
    }
